...
public class IssueDashboardActivity extends
        TabPagerActivity<IssueDashboardPagerAdapter> implements
        OnNavigationListener, OrganizationSelectionProvider,
        LoaderCallbacks<List<User>> {

    private static final String TAG = "IssueDashboardActivity";
        ...
        getSupportLoaderManager().restartLoader(0, null,
                new LoaderCallbacks<List<User>>() {
                    ...
                    public Loader<List<User>> onCreateLoader(int id,
                            Bundle bundle) {
                        return IssueDashboardActivity.this.onCreateLoader(id,
                                bundle);
                    }
                    ...
                    public void onLoadFinished(Loader<List<User>> loader,
                        ...
                        IssueDashboardActivity.this.onLoadFinished(loader,
                                users);
                        if (users.isEmpty())
                            return;
                    ...
                    public void onLoaderReset(Loader<List<User>> loader) {
                        IssueDashboardActivity.this.onLoaderReset(loader);
                    }
                });
    }
